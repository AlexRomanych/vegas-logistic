    ...
    <div class="ml-2 mt-2">
        ...
        >
            ...
            <AppLabelMultiline
                ...
                :title="render.plugCellsGroup.title ? (typeof render.plugCellsGroup.title === 'function' ? render.plugCellsGroup.title() : render.plugCellsGroup.title) : ''"
                :type="typeof render.plugCellsGroup.type === 'function' ? render.plugCellsGroup.type() : render.plugCellsGroup.type"
            ...
            <AppLabelMultiline
                ...
                :title="render.plugCategoryReason.title ? (typeof render.plugCategoryReason.title === 'function' ? render.plugCategoryReason.title() : render.plugCategoryReason.title) : ''"
                :type="typeof render.plugCategoryReason.type === 'function' ? render.plugCategoryReason.type() : render.plugCategoryReason.type"
            ...
            <AppLabelMultiline
                ...
                :title="render.id.title ? (typeof render.id.title === 'function' ? render.id.title() : render.id.title) : ''"
            ...
            <div>
                ...
                <AppLabelMultiline
                    ...
                    :title="render.name.title ? (typeof render.name.title === 'function' ? render.name.title() : render.name.title) : ''"
            ...
            <div>
                <AppLabelMultiline
                    ...
                    :title="render.displayName.title ? (typeof render.displayName.title === 'function' ? render.displayName.title() : render.displayName.title) : ''"
                    :type="typeof render.displayName.type === 'function' ? render.displayName.type() : render.displayName.type"
            ...
            <div>
                ...
                <AppLabelMultiline
                    ...
                    :title="render.active.title ? (typeof render.active.title === 'function' ? render.active.title() : render.active.title) : ''"
            ...
            <div>
                ...
                <AppLabelMultiline
                    ...
                    :title="render.description.title ? (typeof render.description.title === 'function' ? render.description.title() : render.description.title) : ''"
            ...
            <div v-for="cellGroup in reasons" :key="cellGroup.id">
                ...
                <div class="flex">
                    ...
                    <AppLabel
                        ...
                        :title="render.cellGroupName.title ? (typeof render.cellGroupName.title === 'function' ? render.cellGroupName.title() : render.cellGroupName.title) : ''"
                        :type="typeof render.cellGroupName.type === 'function' ? render.cellGroupName.type() : render.cellGroupName.type"
                    ...
                    <div v-for="reasonsCategory in cellGroup.reason_categories" :key="reasonsCategory.id">
                        ...
                        <div class="flex">
                            ...
                            <AppLabel
                                ...
                                :title="render.reasonCategory.title ? (typeof render.reasonCategory.title === 'function' ? render.reasonCategory.title() : render.reasonCategory.title) : ''"
                                :type="typeof render.reasonCategory.type === 'function' ? render.reasonCategory.type() : render.reasonCategory.type"
