...
<script lang="ts" setup>
    import type { IMaterial, IColorTypes } from '@/types'
    ...
    const shortData = computed(() => {
        if (props.material && props.material.properties) {
            return Object.entries(props.material.properties).map(([label, value]) => ({
                label,
                value,
            }))
            // const result = []
