<template>
    <div class="ml-2 mt-2 p-2 border-2 border-slate-400 rounded-lg text-slate-600 w-[700px] font-semibold ">
        <div v-for="cell in cells" :key="cell.id" class="hover:bg-slate-500 hover:text-slate-100 rounded-lg">
...
const getRouteName = (url) => 'manufacture.cell.' + url.replace('/', '.')
