<template>
    <div
        class="min-h-[900px] bg-slate-950 p-8 text-slate-300 relative overflow-hidden flex flex-col"
    ...
    >
        ...
        >
            ...
            >
                ...
                <div
                    ...
                    class="absolute inset-0 border-l-2 border-r-2 border-blue-500 pointer-events-none"
                ></div>
            </div>
        </div>
        ...
        <Teleport to="body">
            <Transition name="fade">
                ...
                >
                    <div
                        class="px-4 py-2 text-[10px] font-bold text-slate-500 uppercase tracking-widest border-b border-slate-700/50 mb-1">
