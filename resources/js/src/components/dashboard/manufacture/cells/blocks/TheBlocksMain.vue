...
const menuItems = ref<IMenuItem[]>([
    { name: 'Справочник коллекций блоков', path: 'manufacture.cell.blocks.collections.show', shown: true, isActive: true },
    ...
    // { name: 'Конструкторская документация блоков (КДБ)', path: 'manufacture.textile.design.show', shown: true, isActive: true },
])
