...
const render: IRenderData = reactive({
    ...
    id:          {
        ...
        dataAlign:      DATA_ALIGN,
        placeholder:    '🔍id...',
        data:           (/*blockLine: IBlockTaskLine*/) => 'ID'
    },
    position:    {
        id:             () => 'position-search',
        header:         ['', ''],
    ...
    name:       {
        ...
        dataAlign:      DATA_ALIGN,
        placeholder:    '🔍Блок...',
        data:           (/*blockLine: IBlockTaskLine*/) => 'Блок'
    },
    amount:      {
        id:             () => 'amount-search',
        header:         ['', ''],
    ...
    time:      {
        ...
        dataAlign:      DATA_ALIGN,
        placeholder:    '🔍Время...',
        data:           (/*blockLine: IBlockTaskLine*/) => 'Время'
    },
    line_1:   {
        id:             () => 'line-1-search',
        header:         ['', ''],
        ...
        dataAlign:      'center',
        placeholder:    '🔍Линия 1...',
        data:           (/*blockLine: IBlockTaskLine*/) => '1'
    },
    line_2:   {
        id:             () => 'line-2-search',
        header:         ['', ''],
        ...
        dataAlign:      'center',
        placeholder:    '🔍Линия 2...',
        data:           (/*blockLine: IBlockTaskLine*/) => '2'
    },
    line_0:   {
        id:             () => 'line-0-search',
        header:         ['', ''],
    ...
    kdb:     {
        ...
        dataAlign:      'center',
        placeholder:    '🔍КДБ...',
        data:           (/*blockLine: IBlockTaskLine*/) => 'КДБ'
    },
    finished_at: {
        ...
        dataAlign:      DATA_ALIGN,
        placeholder:    '🔍...',
        data:           (/*blockLine: IBlockTaskLine*/) => 'Завершено'
    },
    false_reason:  {
        ...
        dataAlign:      DATA_ALIGN,
        placeholder:    '🔍Причина...',
        data:           (/*blockLine: IBlockTaskLine*/) => 'Причина',
    },
})
