...
import type { IPlanLoadsMatrixDay } from '@/types'
import type { IColorTypes } from '@/app/constants/colorsClasses.ts'

import { formatDateInFullFormat, getDateFromDateTimeString, isHoliday, isToday } from '@/app/helpers/helpers_date'
import { usePlansStore } from '@/stores/PlansStore.ts'
import { storeToRefs } from 'pinia'
import { ifDateInPeriod } from '@/app/helpers/plan/helpers_plan.ts'

import PlanLoadItem from '@/components/dashboard/plans/plan_loads/PlanLoadItem.vue'
import AppLabelTS from '@/components/ui/labels/AppLabelTS.vue'
import TheDividerLine from '@/components/ui/dividers/TheDividerLine.vue'

interface IProps {
    date: Date,
    day?: IPlanLoadsMatrixDay
}
