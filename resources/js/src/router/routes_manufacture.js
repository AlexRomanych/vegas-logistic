...
const manufactureRaw = [
    ...
    // info Группы ПЯ
    {
        ...
        component: () =>
            import(
                '/resources/js/src/components/dashboard/manufacture/groups/TheCellsGroupsShow.vue'
            ),
    ...
    // info сами ПЯ
    {
        ...
        component: () =>
            import('/resources/js/src/components/dashboard/manufacture/tasks/TheCellsTaskShow.vue'),
...
*/
    ...
    //info Пошив (автоматы) hr ok
    {
        ...
        component: () =>
            import(
                '/resources/js/src/components/dashboard/manufacture/cells/sewing/TheSewingCellAuto.vue'
            ),
        meta: {
    ...
    //info Сборка Lamit
    {
        ...
        // name: getRouteName(this.path),
        component: () => import('@/components/dashboard/manufacture/cells/TheCellStopper.vue'), //Заглушка
    },
    //info Сборка Столы
    {
    ...
    //info Пошив (автоматы) hr ok
    {
        ...
        component: () =>
            import(
                '/resources/js/src/components/dashboard/manufacture/tasks/sewing/TheSewingCellAutoTask.vue'
            ),
        meta: {
