...
import { PERIOD_LENGTH } from '@/app/constants/dates.js'
...
// ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
// __ Возвращает дату в формате "10ч. 59м. 59с."
// __ type - sec, min, hour - вид входящих данных: секунды, минуты, часы
// !!! Warn: Значение должно быть положительное
