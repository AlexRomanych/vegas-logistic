...
export function isTaskAverage(entity: ISewingTask | ISewingTaskLine[]) {
...
export const orderSewingTasksByStatus = (tasks: ISewingTask[]): ISewingTask[] => {
    ...
    const statusPriority: Record<number, number> = {
        ...
        [SEWING_TASK_STATUSES.CREATED.ID]: 5,
    }
