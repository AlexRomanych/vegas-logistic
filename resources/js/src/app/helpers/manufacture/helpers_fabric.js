...
export const getStyleTypeByFabricTaskStatusCode = function (taskStatusCode = 0) {
    if (!taskStatusCode) return 'dark'
...
export const getTitleByFabricTaskStatusCode = function (taskStatusCode = 0) {
    if (!taskStatusCode) return ''
