                                ...
                                case 'ADDED':
                                    ...
                                    foreach ($sourceLine->sectors as $sector) {
                                        ...
                                        if (isset($lineDiff['amount']['new']) && $lineDiff['amount']['new']) {
                                            ...
                                            $newSector->expense = $lineDiff['amount']['new'] * $newSector->expense_per_pic;
                                            $newSector->total   = $lineDiff['amount']['new'] * $newSector->total_per_pic;
                                            $newSector->rest    = $lineDiff['amount']['new'] * $newSector->rest_per_pic;
                                        }
                                ...
                                case 'UPDATED':
                                    ...
                                    if (isset($lineDiff['amount']['new']) && $lineDiff['amount']['new']) {
                                        ...
                                        foreach ($sourceLine->sectors as $sector) {
                                            ...
                                            $sector->expense = $lineDiff['amount']['new'] * $sector->expense_per_pic;
                                            $sector->total   = $lineDiff['amount']['new'] * $sector->total_per_pic;
                                            $sector->rest    = $lineDiff['amount']['new'] * $sector->rest_per_pic;
                                            $sector->save();
                                        }
                                    }
