...
class OrderLineModelRenderResource extends JsonResource
{
    /**
    ...
    public function toArray(Request $request): array
    {
        return [
            ...
            'model_type'        => $this->modelType->name,  // __ Оставляем из Типа модели только имя изделия
            ...
            'is_solid_light' => $this->is_solid_light,
