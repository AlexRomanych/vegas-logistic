...
class AssemblyTaskStatusResource extends JsonResource
{
    /**
    ...
    public function toArray(Request $request): array
    {
        ...
        return [
            ...
            'pivot' => [
                ...
                // 'cutting_task_id'        => $this->pivot->cutting_task_id,
                // 'cutting_task_status_id' => $this->pivot->cutting_task_status_id,
