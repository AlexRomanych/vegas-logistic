...
class AssemblyTaskResource extends JsonResource
{
    /**
    ...
    public function toArray(Request $request): array
    {
        ...
        return [
            ...
            'created_at' => Carbon::parse($this->created_at)->format(RETURN_DATE_TIME_FORMAT),

            'order' => new AssemblyTaskOrderResource($this->whenLoaded('order')),

            'assembly_lines' => AssemblyTaskLineResource::collection($this->whenLoaded('lines')), // 'cutting_lines
