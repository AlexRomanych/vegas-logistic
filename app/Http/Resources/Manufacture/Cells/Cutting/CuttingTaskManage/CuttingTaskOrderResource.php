...
class CuttingTaskOrderResource extends JsonResource
{
    /**
    ...
    public function toArray(Request $request): array
    {
        ...
        return [
            ...
            'client'          => new CuttingTaskOrderClientResource($this->whenLoaded('client')),
            'order_type'      => new CuttingTaskOrderTypeResource($this->whenLoaded('orderType')),
