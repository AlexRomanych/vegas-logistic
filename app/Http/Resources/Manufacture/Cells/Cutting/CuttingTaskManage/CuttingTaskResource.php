...
class CuttingTaskResource extends JsonResource
{
    /**
    ...
    public function toArray(Request $request): array
    {
        ...
        return [
            ...
            'order' => new CuttingTaskOrderResource($this->whenLoaded('order')),

            'cutting_lines' => CuttingTaskLineResource::collection($this->whenLoaded('cuttingLines')), // 'cutting_lines

            'statuses'       => CuttingTaskStatusResource::collection($this->whenLoaded('statuses')),
            'current_status' => $currentStatus ? new CuttingTaskStatusResource($currentStatus) : null,
