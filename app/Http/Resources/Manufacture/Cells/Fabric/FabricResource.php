...
class FabricResource extends JsonResource
{
    ...
    public function toArray(Request $request): array
    {
        ...
        return [
            ...
            'machines'              => [
                [
                    // __ Тут дергаем стегальную машину через цепочку отношений ПС->Рисунок ПС->Стегальная машина (Fabric->FabricPicture->FabricMachine)
                    'id'         => $this->fabricPicture->fabricMainMachine->id,
                    'short_name' => $this->fabricPicture->fabricMainMachine->short_name,
                ],
                [
                    'id'         => $this->fabricPicture->fabricAltMachine_1->id,
                    'short_name' => $this->fabricPicture->fabricAltMachine_1->short_name,
                ],
                [
                    'id'         => $this->fabricPicture->fabricAltMachine_2->id,
                    'short_name' => $this->fabricPicture->fabricAltMachine_2->short_name,
                ],
                [
                    'id'         => $this->fabricPicture->fabricAltMachine_3->id,
                    'short_name' => $this->fabricPicture->fabricAltMachine_3->short_name,
                ],
            ],
            ...
            'cutting_layers' => $this->cutting_layers,
