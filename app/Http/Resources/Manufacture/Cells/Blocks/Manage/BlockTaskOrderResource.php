...
class BlockTaskOrderResource extends JsonResource
{
    /**
    ...
    public function toArray(Request $request): array
    {
        ...
        return [
            ...
            'client'          => new BlockTaskOrderClientResource($this->whenLoaded('client')),
            'order_type'      => new BlockTaskOrderTypeResource($this->whenLoaded('orderType')),
