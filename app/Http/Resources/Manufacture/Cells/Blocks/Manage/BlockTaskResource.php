...
class BlockTaskResource extends JsonResource
{
    /**
    ...
    public function toArray(Request $request): array
    {
        ...
        return [
            ...
            'block_lines' => BlockTaskLineResource::collection($this->whenLoaded('blockLines')), // 'cutting_lines

            'statuses'       => BlockTaskStatusResource::collection($this->whenLoaded('statuses')),
            'current_status' => $currentStatus ? new BlockTaskStatusResource($currentStatus) : null,
