...
namespace App\Http\Resources\Model\Labors\Sewing;

use Illuminate\Http\Resources\Json\JsonResource;

class SewingCollectionGroupResource extends JsonResource
{
    /**
    ...
    public function toArray($request): array
    {
        ...
        return $this->map(function ($models, $collectionName) {
            return [
                ...
                'items' => SewingModelLaborResource::collection($models),  // __ Используем ресурс для самих моделей
            ];
        })
