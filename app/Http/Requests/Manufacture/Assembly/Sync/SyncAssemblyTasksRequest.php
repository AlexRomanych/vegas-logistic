...
namespace App\Http\Requests\Manufacture\Assembly\Sync;

// use Illuminate\Contracts\Validation\ValidationRule;
use Illuminate\Foundation\Http\FormRequest;

class SyncAssemblyTasksRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            // Валидация задачи (ICuttingTaskArrayDiff)
            ...
            //
            // // Валидация строк (ICuttingTaskArrayLineDiffs)
