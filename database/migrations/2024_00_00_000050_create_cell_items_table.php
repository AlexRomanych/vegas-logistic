...
//        ]);
        ...
        DB::table('cell_items')->insert([
            ...
            ['code1C' => 'ПЯ004', 'no' => 4, 'name' => 'Стежка Кореец', 'unit' => Unit::PRODUCTIVITY_METERS_LINEAR_PER_HOUR, 'source' => '', 'cells_group_id' => 1, 'cell_norm_id' => 4, 'url' => 'stitch/korean'],
            ['code1C' => 'ПЯ005', 'no' => 5, 'name' => 'Стежка одноиголка', 'unit' => Unit::PRODUCTIVITY_METERS_LINEAR_PER_HOUR, 'source' => '', 'cells_group_id' => 1, 'cell_norm_id' => 5, 'url' => 'stitch/one_needle'],
            ['code1C' => 'ПЯ006', 'no' => 6, 'name' => 'Раскрой (панели чехла)', 'unit' => Unit::PRODUCTIVITY_METERS_PER_HOUR, 'source' => '', 'cells_group_id' => 2, 'cell_norm_id' => 6, 'url' => 'cutting/cover_panel'],
            ['code1C' => 'ПЯ007', 'no' => 7, 'name' => 'Раскрой (дет. чехла)', 'unit' => Unit::PRODUCTIVITY_METERS_PER_HOUR, 'source' => '', 'cells_group_id' => 2, 'cell_norm_id' => 7, 'url' => 'cutting/cover_panel_child'],
            ['code1C' => 'ПЯ008', 'no' => 8, 'name' => 'Оверлок', 'unit' => Unit::PRODUCTIVITY_METERS_PER_SECOND, 'source' => '', 'cells_group_id' => 3, 'cell_norm_id' => 8, 'url' => 'overloсk'],
            ['code1C' => 'ПЯ009', 'no' => 9, 'name' => 'Пошив (автоматы)', 'unit' => Unit::PRODUCTIVITY_METERS_PER_HOUR, 'source' => 'Справочник моделей в 1С', 'cells_group_id' => 3, 'cell_norm_id' => 9, 'url' => 'sewing/auto'],
            ['code1C' => 'ПЯ010', 'no' => 10, 'name' => 'Пошив (УШМ)', 'unit' => Unit::PRODUCTIVITY_METERS_PER_HOUR, 'source' => 'Справочник моделей в 1С', 'cells_group_id' => 3, 'cell_norm_id' => 10, 'url' => 'sewing/universal'],
            ['code1C' => 'ПЯ011', 'no' => 11, 'name' => 'Обшивка 1 (hard)', 'unit' => Unit::PRODUCTIVITY_METERS_PER_HOUR, 'source' => 'Справочник моделей в 1С', 'cells_group_id' => 3, 'cell_norm_id' => 11, 'url' => 'sewing/hard'],
            ['code1C' => 'ПЯ012', 'no' => 12, 'name' => 'Обшивка 1 (lite)', 'unit' => Unit::PRODUCTIVITY_METERS_PER_HOUR, 'source' => 'Справочник моделей в 1С', 'cells_group_id' => 3, 'cell_norm_id' => 12, 'url' => 'sewing/light'],
            ['code1C' => 'ПЯ013', 'no' => 13, 'name' => 'Сборка Lamit', 'unit' => Unit::PRODUCTIVITY_PICS_PER_HOUR, 'source' => 'Справочник моделей в 1С', 'cells_group_id' => 4, 'cell_norm_id' => 13, 'url' => 'assembly/lamit'],
            ['code1C' => 'ПЯ014', 'no' => 14, 'name' => 'Сборка Столы', 'unit' => Unit::PRODUCTIVITY_PICS_PER_HOUR, 'source' => 'Справочник моделей в 1С', 'cells_group_id' => 4, 'cell_norm_id' => 14, 'url' => 'assembly/table'],
            ['code1C' => 'ПЯ015', 'no' => 15, 'name' => 'Упаковка', 'unit' => Unit::PRODUCTIVITY_PICS_PER_HOUR, 'source' => '', 'cells_group_id' => 5, 'cell_norm_id' => 15, 'url' => 'pack'],
            ['code1C' => 'ПЯ016', 'no' => 16, 'name' => 'НПБ(производство)', 'unit' => Unit::PRODUCTIVITY_SQUARE_METERS_PER_HOUR, 'source' => '', 'cells_group_id' => 6, 'cell_norm_id' => 15, 'url' => 'blocks'],
        ]);
