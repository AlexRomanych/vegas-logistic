...
return new class extends Migration
{
    ...
    private const TABLE_NAME = 'cutting_task_status_pivot';
    ...
    public function up(): void
    {
        Schema::create(self::TABLE_NAME, function (Blueprint $table) {
            ...
            $table->foreignId('cutting_task_id')
                ->nullable(false)
                ->comment('Связь с СЗ')
                ->constrained('cutting_tasks', 'id')
                ->cascadeOnDelete();

            $table->foreignId('cutting_task_status_id')
                ->nullable(false)
                ->comment('Связь со статусом')
                ->constrained('cutting_task_statuses', 'id')
                ->cascadeOnDelete();
            ...
            // $table->unique(['cutting_task_id', 'cutting_task_status_id']);
